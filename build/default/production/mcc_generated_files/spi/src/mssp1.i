# 1 "mcc_generated_files/spi/src/mssp1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/spi/src/mssp1.c" 2
# 34 "mcc_generated_files/spi/src/mssp1.c"
...
# 34 "mcc_generated_files/spi/src/mssp1.c" 2

# 1 "mcc_generated_files/spi/src/../mssp1.h" 1
# 38 "mcc_generated_files/spi/src/../mssp1.h"
...
# 38 "mcc_generated_files/spi/src/../spi_interface.h" 2
...
# 38 "mcc_generated_files/spi/src/../mssp1.h" 2
...
# 36 "mcc_generated_files/spi/src/mssp1.c" 2
...
_Bool SPI1_IsRxReady(void)
{
    ...
    {
        returnValue = ((PIR3bits.SSP1IF != 0U) ? 1: 0);
    }
    else
    {
        returnValue = 0;
...
_Bool SPI1_IsTxReady(void)
{
    ...
    if (SSP1CON1bits.SSPEN == 1)
    {
        returnValue = ((PIR3bits.SSP1IF != 0U) ? 0: 1);
    }
    else
    {
        returnValue = 0;
